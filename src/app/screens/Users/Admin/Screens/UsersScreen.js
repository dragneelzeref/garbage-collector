...
class UsersScreen extends Component {
  ...
  componentDidMount() {
    getUsers(this.props, this.hideFooterLoading);
  }
  componentDidUpdate(prevProps) {
    if (prevProps.workersUsers.users != this.props.workersUsers.users) {
      this.setState({
  ...
  headerRightAction = () => {
    if (this.state.headerRightIcon === edit) {
      ...
      deleteWorkers(this.props, this.state.users, this.hideActivityIndicator);
      this.setState({ headerLeftIcon: menu, headerRightIcon: edit });
    }
  };
